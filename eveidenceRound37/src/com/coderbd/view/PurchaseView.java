...
public class PurchaseView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblSummary.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Code", "Total Qty", "Sold Qty", "Available Qty"
            }
        ));
    ...
    private void btnPurchaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPurchaseActionPerformed
        ...
        Purchase p = new Purchase(txtPName.getText(), txtPCode.getText(), Integer.parseInt(txtQty.getText()), Double.parseDouble(txtUnitPrice.getText()), Double.parseDouble(txtTotalPrice.getText()), new Date());
